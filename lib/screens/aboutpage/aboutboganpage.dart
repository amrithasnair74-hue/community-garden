...
class boganpage extends StatefulWidget {
  const boganpage({super.key});

  @override
  State<boganpage> createState() => _boganpageState();
}

class _boganpageState extends State<boganpage> {
  @override
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(AppImages.boganimage),
              ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "A boganvilla is a small to medium woody plant, shorter than a tree,"
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const boganpayement()),
                    );},
