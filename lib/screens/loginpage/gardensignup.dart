...
final TextEditingController Confirmpasswordcontroller =TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.green,title: Text('EcoBloom'),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Image.asset(
                AppImages.secondimage,height: 150,
              ),
             ...
             Customwork(hintText: "Password", controller: passwordcontroller, icon:Icons.visibility_off_outlined),
              SizedBox(height: 20),
              
             Customwork(hintText: "Confirmpassword", controller: Confirmpasswordcontroller, icon:Icons.visibility_off_outlined),
              SizedBox(height: 20),
               SizedBox(height: 20),
