...
class _GardensplashState extends State<Gardensplash> {
  void initState(){navigateHome();super.initState();}
  navigateHome() async{
    await Future.delayed(Duration(seconds:5));
    Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>Gardenfirst()));
  }
  @override
 ...
 backgroundColor: Appcolor.backgroundcolor,
      body:
      Center(
        child: Image.asset(AppImages.splashimage,height: 200,),
